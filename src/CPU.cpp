...
CPU::CPU(MMU& mmu)
    ...
    , CBOpcodeTable
    {
    /*0x00*/ WrapFunc(cpu.RLC(cpu.registers.b)),
    /*0x01*/ WrapFunc(cpu.RLC(cpu.registers.c)),
    /*0x02*/ WrapFunc(cpu.RLC(cpu.registers.d)),
    /*0x03*/ WrapFunc(cpu.RLC(cpu.registers.e)),
    /*0x04*/ WrapFunc(cpu.RLC(cpu.registers.h)),
    /*0x05*/ WrapFunc(cpu.RLC(cpu.registers.l)),
    /*0x06*/ WrapFunc(cpu.ApplyToAddress(Address(cpu.registers.hl), CPU::RLC, 2)),
    /*0x07*/ WrapFunc(cpu.RLC(cpu.registers.a)),
    /*0x08*/ WrapFunc(cpu.RRC(cpu.registers.b)),
    /*0x09*/ WrapFunc(cpu.RRC(cpu.registers.c)),
    /*0x0A*/ WrapFunc(cpu.RRC(cpu.registers.d)),
    /*0x0B*/ WrapFunc(cpu.RRC(cpu.registers.e)),
    /*0x0C*/ WrapFunc(cpu.RRC(cpu.registers.h)),
    /*0x0D*/ WrapFunc(cpu.RRC(cpu.registers.l)),
    /*0x0E*/ WrapFunc(cpu.ApplyToAddress(Address(cpu.registers.hl), CPU::RRC, 2)),
    /*0x0F*/ WrapFunc(cpu.RRC(cpu.registers.a)),

    /*0x10*/ WrapFunc(cpu.RL(cpu.registers.b)),
    /*0x11*/ WrapFunc(cpu.RL(cpu.registers.c)),
    /*0x12*/ WrapFunc(cpu.RL(cpu.registers.d)),
    /*0x13*/ WrapFunc(cpu.RL(cpu.registers.e)),
    /*0x14*/ WrapFunc(cpu.RL(cpu.registers.h)),
    /*0x15*/ WrapFunc(cpu.RL(cpu.registers.l)),
    /*0x16*/ WrapFunc(cpu.ApplyToAddress(Address(cpu.registers.hl), CPU::RL, 2)),
    /*0x17*/ WrapFunc(cpu.RL(cpu.registers.a)),
    /*0x18*/ WrapFunc(cpu.RR(cpu.registers.b)),
    /*0x19*/ WrapFunc(cpu.RR(cpu.registers.c)),
    /*0x1A*/ WrapFunc(cpu.RR(cpu.registers.d)),
    /*0x1B*/ WrapFunc(cpu.RR(cpu.registers.e)),
    /*0x1C*/ WrapFunc(cpu.RR(cpu.registers.h)),
    /*0x1D*/ WrapFunc(cpu.RR(cpu.registers.l)),
    /*0x1E*/ WrapFunc(cpu.ApplyToAddress(Address(cpu.registers.hl), CPU::RR, 2)),
    /*0x1F*/ WrapFunc(cpu.RR(cpu.registers.a)),

    /*0x20*/ WrapFunc(cpu.SLA(cpu.registers.b)),
    /*0x21*/ WrapFunc(cpu.SLA(cpu.registers.c)),
    /*0x22*/ WrapFunc(cpu.SLA(cpu.registers.d)),
    /*0x23*/ WrapFunc(cpu.SLA(cpu.registers.e)),
    /*0x24*/ WrapFunc(cpu.SLA(cpu.registers.h)),
    /*0x25*/ WrapFunc(cpu.SLA(cpu.registers.l)),
    /*0x26*/ WrapFunc(cpu.ApplyToAddress(Address(cpu.registers.hl), CPU::SLA, 2)),
    /*0x27*/ WrapFunc(cpu.SLA(cpu.registers.a)),
    /*0x28*/ WrapFunc(cpu.SRA(cpu.registers.b)),
    /*0x29*/ WrapFunc(cpu.SRA(cpu.registers.c)),
    /*0x2A*/ WrapFunc(cpu.SRA(cpu.registers.d)),
    /*0x2B*/ WrapFunc(cpu.SRA(cpu.registers.e)),
    /*0x2C*/ WrapFunc(cpu.SRA(cpu.registers.h)),
    /*0x2D*/ WrapFunc(cpu.SRA(cpu.registers.l)),
    /*0x2E*/ WrapFunc(cpu.ApplyToAddress(Address(cpu.registers.hl), CPU::SRA, 2)),
    /*0x2F*/ WrapFunc(cpu.SRA(cpu.registers.a)),

    /*0x30*/ WrapFunc(cpu.SWAP(cpu.registers.b)),
    /*0x31*/ WrapFunc(cpu.SWAP(cpu.registers.c)),
    /*0x32*/ WrapFunc(cpu.SWAP(cpu.registers.d)),
    /*0x33*/ WrapFunc(cpu.SWAP(cpu.registers.e)),
    /*0x34*/ WrapFunc(cpu.SWAP(cpu.registers.h)),
    /*0x35*/ WrapFunc(cpu.SWAP(cpu.registers.l)),
    /*0x36*/ WrapFunc(cpu.ApplyToAddress(Address(cpu.registers.hl), CPU::SWAP, 2)),
    /*0x37*/ WrapFunc(cpu.SWAP(cpu.registers.a)),
    /*0x38*/ WrapFunc(cpu.SRL(cpu.registers.b)),
    /*0x39*/ WrapFunc(cpu.SRL(cpu.registers.c)),
    /*0x3A*/ WrapFunc(cpu.SRL(cpu.registers.d)),
    /*0x3B*/ WrapFunc(cpu.SRL(cpu.registers.e)),
    /*0x3C*/ WrapFunc(cpu.SRL(cpu.registers.h)),
    /*0x3D*/ WrapFunc(cpu.SRL(cpu.registers.l)),
    /*0x3E*/ WrapFunc(cpu.ApplyToAddress(Address(cpu.registers.hl), CPU::SRL, 2)),
    /*0x3F*/ WrapFunc(cpu.SRL(cpu.registers.a)),
    }
{
    registers.af = 0x01B0;
    registers.bc = 0x0013;
